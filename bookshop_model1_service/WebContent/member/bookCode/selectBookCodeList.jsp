	...
	<body>
		...
		%>
			<tr>
				...
				<td><a href="<%=request.getContextPath() %>/member/bookCode/updateBookCodeForm.jsp?bookCodeNo=<%=dto.getBookCodeNo() %>">수정</a></td>
				<td><a href="<%=request.getContextPath() %>/member/bookCode/deleteBookCodeAction.jsp?bookCodeNo=<%=dto.getBookCodeNo() %>">삭제</a></td>
			</tr>
		<%
			}
		%>
