...
public class BookCodeDAO {
	...
	public int updateBookCode(BookCodeDTO bookCodeDTO) {
		//리턴값을 담을 변수
		int check = 0;
		...
		try {
			...
			JdbcObject.getPreparedStatement().setString(1, bookCodeDTO.getBookCodeName());
			JdbcObject.getPreparedStatement().setInt(2, bookCodeDTO.getBookCodeNo());
